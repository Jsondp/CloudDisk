...
public:
    ...
    void setupUi(QWidget *ButtonGroup)
    {
        ...
        myfile->setFont(font);
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/tile_file.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/images/tile_hot.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QWidget *ButtonGroup)
    {
        ...
        login_usr->setText(QApplication::translate("ButtonGroup", "kevin", 0));
