...
void ShareList::refreshFiles()
{
    ...
    QString url = QString("http:// %1:%2/sharefiles?cmd=count").arg(QString("192.168.230.138")).arg(QString("80"));
...
void ShareList::getUserFilesList()
{
    ...
    QString url;
    url = QString("http:// %1:%2/sharefiles?cmd=normal").arg(QString("192.168.230.138")).arg(QString("80"));
...
void ShareList::dealFilePv(QString md5, QString filename)
{
    ...
    QString url = QString("http:// %1:%2/dealsharefile?cmd=pv").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); // 设置url
    cout << "url = " << url;
...
void ShareList::cancelShareFile(FileInfo *info)
{
    ...
    QString url = QString("http:// %1:%2/dealsharefile?cmd=cancel").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); // 设置url
    cout << "url = " << url;
...
void ShareList::saveFileToMyList(FileInfo *info)
{
    ...
    QString url = QString("http:// %1:%2/dealsharefile?cmd=save").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); // 设置url
    cout << "url = " << url;
