...
void MyFileWg::uploadFilesAction()
{
    ...
    QString url = QString("http://%1:%2/md5").arg(QString("192.168.230.138")).arg(QString("80"));
...
void MyFileWg::uploadFile(UploadFileInfo *info)
{
    ...
    */
    ...
    QString url = QString("http://%1:%2/upload").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); //设置url
...
void MyFileWg::refreshFiles(MyFileWg::Display cmd)
{
    ...
    QString url = QString("http://%1:%2/myfiles?cmd=count").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); //设置url
...
void MyFileWg::getUserFilesList(MyFileWg::Display cmd)
{
    ...
    url = QString("http://%1:%2/myfiles?cmd=%3").arg(QString("192.168.230.138")).arg(QString("80")).arg(tmp);
    request.setUrl(QUrl( url )); //设置url
...
void MyFileWg::shareFile(FileInfo *info)
{
    ...
    QString url = QString("http://%1:%2/dealfile?cmd=share").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); //设置url
...
void MyFileWg::delFile(FileInfo *info)
{
    ...
    QString url = QString("http://%1:%2/dealfile?cmd=del").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); //设置url
...
void MyFileWg::dealFilePv(QString md5, QString filename)
{
    ...
    QString url = QString("http://%1:%2/dealfile?cmd=pv").arg(QString("192.168.230.138")).arg(QString("80"));
    request.setUrl(QUrl( url )); //设置url
